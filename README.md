...
> [!NOTE]
> Run `php artisan migrate --seed` in terminal to insert the required tables and a ***superadmin*** account to the database to avoid unnecessary errors.

After running the above command, go to the folders listed below to get a superadmin account:
```
database > seeders > DatabaseSeeer.php
```
