...
@section('content')
            ...
            <div class="container">
                <div class="row slider-text align-items-center" data-scrollax-parent="true">
                    ...
                    <div class="col-md-6 ftco-animate">
                        <img src="{{ asset('user/images/bg_1.png') }}" class="img-fluid" alt="">
                    </div>
        ...
        <div class="slider-item">
            ...
            <div class="container">
                <div class="row slider-text align-items-center" data-scrollax-parent="true">
                    ...
                    <div class="col-md-6 ftco-animate">
                        <img src="{{ asset('user/images/bg_2.png') }}" class="img-fluid" alt="">
                    </div>
    ...
    <section class="ftco-about d-md-flex">
        ...
        <div class="one-half ftco-animate">
            <div class="heading-section ftco-animate text-white">
                <h2 class="mb-4 fw-bold">Welcome to <span class="flaticon-pizza">Pizza</span> A Restaurant</h2>
            </div>
    ...
    <section class="ftco-section">
        <div class="container">
            <div class="row justify-content-center mb-5 pb-3">
                <div class="col-md-7 heading-section ftco-animate text-center">
                    <h2 class="mb-4 text-warning">Hot Pizza Meals</h2>
                        ...
                        <div class="col d-flex ftco-animate">
                            <div class="services-wrap d-flex">
                                ...
                                <div class="text p-4">
                                    ...
                                    <p class="price text-warning"><span>{{ $list[$index]['price'] }} mmk</span> <a
                        ...
                        <div class="col d-flex ftco-animate">
                            <div class="services-wrap d-flex">
                                ...
                                <div class="text p-4">
                                    ...
                                    <p class="price text-warning"><span>{{ $list[$index]['price'] }} mmk</span>
                                        <a href="{{ route('user#details', $list[$index]['id']) }}"
    ...
    <section class="ftco-counter ftco-bg-dark img" id="section-counter"
        style="background-image: url({{ asset('user/images/bg_2.jpg') }});" data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container">
                        ...
                        <div class="col-md-6 col-lg-3 d-flex justify-content-center counter-wrap ftco-animate">
                            <div class="block-18 text-center">
                                <div class="text">
                                    ...
                                    <strong class="number" data-number="{{ count($list) }}">0</strong>
        ...
        <div class="container-fluid">
            <div class="row d-md-flex">
                <div class="col-lg-4 ftco-animate img f-menu-img mb-5 mb-md-0"
                    style="background-image: url({{ asset('user/images/about.jpg') }});">
                </div>
                        ...
                        <div class="col-md-12 nav-link-wrap mb-5">
                            <div class="nav ftco-animate nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link @if (!request('categoryId')) active @endif rounded"
                                    id="v-pills-1-tab" data-toggle="pill" href="{{ route('user#menu') }}"
                                    role="tab" aria-controls="v-pills-1" aria-selected="true">All</a>
                                @foreach ($categories as $item)
                                    <a class="nav-link @if (request('categoryId') == $item->id) active @endif  rounded"
                                        id="v-pills-1-tab" data-toggle="pill"
                                        href="{{ url('user/home?categoryId=' . $item->id) }}" role="tab"
        ...
        <div class="container-wrap">
            <div class="row no-gutters d-md-flex align-items-center">
                ...
                <div class="col-md-6 appointment ftco-animate">
                    ...
                    <form action="{{ route('user#contact#send') }}" method="post" class="appointment-form">
                        @csrf
                        <div class="d-md-flex">
                        ...
                        <div class="form-group">
                            <textarea name="message" id="" cols="30" rows="3" class="form-control" placeholder="Message">{{ old('message') }}</textarea>
                            @error('message')
                                <small class="text-danger">
                                    {{ $message }}</small>
                            @enderror
                        ...
                        <div class="form-group mt-3">
                            <input type="submit" value="Send" class="btn btn-warning py-3 px-4">
                        </div>
                    </form>
                </div>
            </div>
